...
async function onRequestGet({ env, request }) {
  ...
  try {
    ...
    const filtered = records.filter(Boolean).sort(
...
// ../.wrangler/tmp/pages-bqEA9X/functionsRoutes-0.41491694367792054.mjs
var routes = [
  {
    routePath: "/api/ai",
    mountPath: "/api",
...
// ../../../../.nvm/versions/node/v20.18.3/lib/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../.nvm/versions/node/v20.18.3/lib/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../../../../.nvm/versions/node/v20.18.3/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../.nvm/versions/node/v20.18.3/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-qDrq1x/middleware-insertion-facade.js
...
// ../../../../.nvm/versions/node/v20.18.3/lib/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-qDrq1x/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.04449953689085029.mjs.map
