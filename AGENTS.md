...
This project is indexed by GitNexus as **meta-agent** (621 symbols, 1533 relationships, 43 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
